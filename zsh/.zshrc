...
export BAO_ADDR="https://bao.dbd.sh"
...
export PATH="$HOME/bin:/opt/homebrew/bin:$HOME/go/bin:$PATH:/usr/local/go/bin:$HOME/gems/bin:$HOME/.krew/bin:$HOME/.local/bin:/Users/dbd/Library/Python/3.9/bin"
