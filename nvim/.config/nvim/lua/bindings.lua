...
vim.api.nvim_set_keymap("n", "<leader>cc", "<cmd>lua require('agent').toggle_agent()<CR>", {silent = true, desc = "Toggle Agent"})
vim.api.nvim_set_keymap("n", "<leader>cf", ":AgentFile<CR>", {silent = true, desc = "Agent with current file"})
